...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 FST from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 fastcoin in block rewards plus fees, but
        ...
        # Send 100000 FST with subtract fee from amount
