...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 7,500,000 FST:
        ...
        # First: use raw transaction API to send 7499960 FST to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500,000 FST for another
