...
const char * const BITCOIN_CONF_FILENAME = "fastcoin.conf";
const char * const BITCOIN_PID_FILENAME = "fastcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fastcoin";
#else
    // Unix
