...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("vps-dnsseed01.fastcoin-project.org", "vps-dnsseed01.fastcoin-project.org", true));
        vSeeds.push_back(CDNSSeedData("vps-dnsseed02.fastcoin-project.org", "vps-dnsseed02.fastcoin-project.org", true));
        vSeeds.push_back(CDNSSeedData("vps-dnsseed03.fastcoin-project.org", "vps-dnsseed03.fastcoin-project.org", true));
